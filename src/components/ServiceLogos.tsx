          ...
          <div className="w-12 h-12 bg-transparent rounded-lg flex items-center justify-center">
            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none">
              ...
              <g>
                ...
                {/* Text "Google AdSense" */}
                <text x="12" y="18" textAnchor="middle" fontSize="3" fill="currentColor" className="text-gray-700 dark:text-gray-300" fontFamily="Arial, sans-serif" fontWeight="400">
                  Google AdSense
                </text>
              </g>
            </svg>
    ...
    <div className="w-full">
      <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 py-2">
        {serviceLogos.map((service, index) => (
          <div
            key={index}
            className="flex items-center justify-center p-3 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all duration-300 hover:scale-105 min-h-[50px]"
            title={service.name}
          >
            {service.logo}
          </div>

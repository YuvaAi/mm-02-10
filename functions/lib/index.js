...
exports.createFacebookAd = functions.https.onCall(async (request) => {
    return await (0, facebookAds_1.createAdSetAndAd)(request.data, { auth: request.auth });
});
exports.createFacebookAdCampaignFunction = functions.https.onCall(async (request) => {
    return await (0, facebookAds_1.createFacebookAdCampaign)(request.data, { auth: request.auth });
});
